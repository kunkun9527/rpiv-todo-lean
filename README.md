...
> **Lean Pi todo extension with full features: 277 initial tokens (69% fewer than original).**
...
This saves **627 tokens (69.4%)** compared to the pinned upstream package.
...
With only this extension enabled, the lean `todo` tool contributes an estimated **277 tokens** of recurring model-facing initialization context. The pinned upstream `@juicesharp/rpiv-todo@2.7.1` tool contributes **904 tokens** under the same conditions. That is **627 fewer tokens (69.4%)**.
